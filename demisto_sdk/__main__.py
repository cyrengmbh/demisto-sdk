...
from demisto_sdk.commands.test_content.test_content import execute_test_content
...
@click.option(
    '-g', '--build-name', help='The current content branch name', required=True)
@click.option(
...
@click.option(
    ...
    default="NonAMI")
@click.option(
    '-l', '--tests-list', help='List of specific, comma separated tests to run')
